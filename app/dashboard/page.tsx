    ...
    <div className="[perspective:1200px] [transform-style:preserve-3d]">
      ...
      >
        ...
        >
          ...
          <h2 className="text-lg md:text-2xl font-semibold relative mb-2">
            {title}
          </h2>
          {satelliteId && (
...
const IntegratedSatelliteDashboard = () => {
  ...
  return (
    <div className="min-h-screen" style={{background: 'linear-gradient(135deg, #0A192F 0%, #1a2844 50%, #0A192F 100%)'}}>
      ...
      <AuroraBackground className="relative">
        <div className="relative w-full py-6">
            ...
            <div className="max-w-7xl mx-auto px-6 mb-6 relative z-10">
              <h2 className="text-xl font-semibold text-white flex items-center">
                <Activity
                  ...
                  style={{ color: "#6C63FF" }}
                />
                <div className="relative flex flex-col items-center justify-center gap-2 text-center sm:flex-row sm:items-baseline">
                  <LayoutTextFlip
                    text="Satellite "
          ...
          <div className='px-6'>
            ...
            <div className="bg-transparent backdrop-blur-2xl rounded-2xl border border-[#6C63FF]/30 p-3 shadow-lg shadow-[#6C63FF]/10 mb-4 mt-5 hover:border-[#6C63FF]/50 transition-all duration-150 hover:bg-black/40">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
              ...
              <div className="xl:col-span-3 space-y-6">
                ...
                <div className="bg-transparent backdrop-blur-2xl rounded-2xl border border-[#6C63FF]/30 p-6 shadow-lg shadow-[#6C63FF]/10 hover:border-[#6C63FF]/50 transition-all duration-150 hover:bg-black/40">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-6">
                      <div className="flex items-center space-x-3">
                        <Target className="w-6 h-6 text-[#00C9FF]" />
                        <div>
                          <h2 className="text-xl font-bold text-white">{currentSatellite?.name}</h2>
                ...
                <div className="bg-transparent backdrop-blur-2xl rounded-2xl border border-[#6C63FF]/30 p-6 shadow-lg shadow-[#6C63FF]/10 hover:border-[#6C63FF]/50 transition-all duration-150 hover:bg-black/40 pr-5">
